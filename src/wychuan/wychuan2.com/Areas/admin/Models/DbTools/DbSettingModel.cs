...
namespace wychuan2.com.Areas.admin.Models.DbTools
{
    ...
    public class DbSettingModel
    {
        ...
        {
            return CookieHelper.Get<LanguageTemplate>(JAVA_DB_SETTING_KEY.format(ApplicationUser.Current.UserName));
        }
        ...
        {
            return CookieHelper.Get<LanguageTemplate>(CSHARP_DB_SETTING_KEY.format(ApplicationUser.Current.UserName));
        }
