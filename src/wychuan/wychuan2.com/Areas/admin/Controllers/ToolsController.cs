...
namespace wychuan2.com.Areas.admin.Controllers
{
    public class ToolsController : Controller
    {
        ...
        public ActionResult ToDoJobs()
        {
            int userId = ApplicationUser.Current.UserId;

            IList<MyTaskDTO> lstToDoJobs = myTaskService.GetToDoTasks(userId);

            return View("_ToDoJobs", lstToDoJobs);
        }
        #endregion
